...
$(document).ready(function () {
	...
	// Countdown //
	$('#countdown').countdown({
		until: new Date(2014, 7 - 1, 19), // new Date(year, mth - 1, day, hr, min, sec) - date/time to count down to
		// or numeric for seconds offset, or string for unit offset(s):
		// 'Y' years, 'O' months, 'W' weeks, 'D' days, 'H' hours, 'M' minutes, 'S' seconds
		// until: '-1m +1d', for demo
		timezone: +5.30, // The timezone (hours or minutes from GMT) for the target times, or null for client local
	...
	// Google Map //
	$('#map_canvas').gmap({
		'center': new google.maps.LatLng(18.559114, 73.911297), // Change this to your desired latitude and longitude
		'zoom': 17,
